...
from fdstk.core.crc import CRC_SIZE, block_crc, decode_crc, encode_crc
...
SHORT_LIMIT: Final = 0x48
CLASS0_LIMIT: Final = 0x70
CLASS1_LIMIT: Final = 0xA0
CLASS2_LIMIT: Final = 0xD0
